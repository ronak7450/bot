    ...
    function fetchData() {
        ...
        fetch("api.php?mobile=" + mobile)
            ...
            .then(data => {
                ...
                const isSuccess = responseData ? (responseData.status === "success" || data.success === true || responseData.success === true) : false;
                const resultsList = responseData && responseData.results ? responseData.results : [];
                
                const isNotFound = !responseData || !isSuccess || resultsList.length === 0;
